...
function loadSofa1() {
    gltfLoader.load("models/sofas/sofa1/components/single.gltf", function (gltf) {
        sofa1.single = setSofa(gltf.scene);
    ...
    gltfLoader.load("models/sofas/sofa1/components/armrestL.gltf", function (gltf) {
        sofa1.armrestL = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/armrestR.gltf", function (gltf) {
        sofa1.armrestR = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/chaise.gltf", function (gltf) {
        sofa1.chaise =  setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/chaiseL.gltf", function (gltf) {
        sofa1.chaiseL = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/chaiseR.gltf", function (gltf) {
        sofa1.chaiseR = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/cornerL.gltf", function (gltf) {
        sofa1.cornerL = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/cornerR.gltf", function (gltf) {
        sofa1.cornerR = setSofa(gltf.scene);

    });
    gltfLoader.load("models/sofas/sofa1/components/ottoman.gltf", function (gltf) {
        sofa1.ottoman = setSofa(gltf.scene);
    ...
    objA.traverse(function (e) {
        ...
        if (e instanceof THREE.Mesh) {
            ...
            if (e.name.includes("Leg")) {
                objA.position.set(0, objA.scale.y / 2 + e.scale.y / 30, 0)
...
function update() {
    controls.update();
    if(sofa1.armrestL)sofa1.armrestL.position.setX(-0.3)
    if(sofa1.armrestL)sofa1.armrestL.position.setZ(0.3)
    if(sofa1.armrestR)sofa1.armrestR.position.setX(0.3)
    if(sofa1.armrestR)sofa1.armrestR.position.setZ(0.3)
    if(sofa1.chaise)sofa1.chaise.visible = false;
    if(sofa1.chaiseL)sofa1.chaiseL.position.setX(-1)
    if(sofa1.chaiseR)sofa1.chaiseR.position.setX(1)
    if(sofa1.cornerL)sofa1.cornerL.position.setX(-2)
    if(sofa1.cornerR)sofa1.cornerR.position.setX(2)
    if(sofa1.ottoman)sofa1.ottoman.position.setZ(2)
...
function create_lights() {
    ...
    directionalLight = new THREE.DirectionalLight(0xfff3db, 3);
    ...
    var directionalLight2 = new THREE.DirectionalLight(0xdedede, 0.5);
